...
function CalendarControl() {
  ...
  const calendarControl = {
    ...
    sendselectDate: (e) => {
      // Get element info
      const date = document.querySelector('form input[name="date"]');
      const month = document.querySelector('form input[name="month"]');
      const year = document.querySelector('form input[name="year"]');
      const button = document.getElementById("submitbutton");
      // Send data into elements
      date.value = e.target.textContent;
      month.value = calendarControl.calMonthName[calendar.getMonth()];
    ...
    attachEvents: function () {
      ...
      let calendar_body = document.querySelectorAll(".calendar-body");
      ...
      for (var i = 0; i < dateNumber.length; i++) {
        ...
        dateNumber[i].addEventListener(
          "click",
          calendarControl.sendselectDate,
          false
        );
      }
    },
